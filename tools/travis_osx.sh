...
conda_pkgs="cmake>=3.3 mppp boost-cpp tbb tbb-devel clang<5 clangdev<5 abseil-cpp"
...
# mkdir build
# cd build
# cmake ../ -DCMAKE_BUILD_TYPE=${OBAKE_BUILD_TYPE} -DCMAKE_INSTALL_PREFIX=$deps_dir -DCMAKE_CXX_STANDARD=17
